...
assert(appUpdate.includes("const APP_VERSION = 'v11';"), "앱 업데이트 버전이 v11이 아닙니다.");
...
assert(sw.includes('transfer-english-trainer-v11') && sw.includes('./exam-mode.js') && sw.includes('./grammar-exam.js') && sw.includes('./new-problems.js') && sw.includes('./content/vocabulary-02.js') && !sw.includes('./app-ux-parity.js'), "서비스 워커 캐시가 최종 문제 UX 구조와 맞지 않습니다.");
